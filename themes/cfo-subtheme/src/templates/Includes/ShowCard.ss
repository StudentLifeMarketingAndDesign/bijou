<div class="showcard clearfix ">
    ...
    <% if $TmdbPoster %>
        <a href="$Link" class="showcard__img">
            <img class="dp-lazy" data-original="$TmdbPoster.FocusFill(267, 400).URL" width="267" height="400" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" alt="$Title">
        </a>
    <% end_if %>
