...
<section class="instafeed" aria-labelledby="instagramid">
    <div class="row">
        <div class="columns">
            ...
            <!-- SnapWidget -->
            <iframe src="https://snapwidget.com/embed/878696" class="snapwidget-widget" allowtransparency="true" frameborder="0" scrolling="no" style="border:none; overflow:hidden;  width:660px; height:330px"></iframe>
